...
const ProfileView = () => {
  ...
  return (
    <Wrapper className="flex flex-col items-center justify-center h-full p-6 bg-gray-900 border-r border-gray-725 xl:w-2/5 xl:p-24 overflow-hidden overflow-y-hidden profile-view">
      <Logo />
